/*global Class Todo todo jQuery DizmoElements */
/**
...
Class("Todo.Dizmo", {
    ...
    methods: {
        ...
        initEvents: function() {
            ...
            viewer.subscribeToAttribute('settings/displaymode', function(val) {
                if (val === 'presentation') {
...
Class("Todo.Main", {
    ...
    methods: {
        initEvents: function() {
            ...
            jQuery(events).on('dizmo.resized', function() {
              jQuery('#todo-list').height(dizmo.getHeight() - 110);
            });
		...
		var i,l,ioe,tid;
            ...
            this.subId=dizmo.publicStorage.subscribeToProperty("dizmo-todos",function(){
                todo.List.refresh();
            });
